					...
					<form>
						<div className={style.headerContatos}>
							...
							<div className={style.buttons}>
								<button className={style.buttom} onClick={Adicionar}>
									{" "}
									<IoAdd />{" "}
								</button>
								<button className={style.buttom} onClick={Editar}>
									{" "}
									<IoPencil />{" "}
								</button>
								<button className={style.buttom} onClick={Deletar}>
									{" "}
									<BsFillTrash3Fill />{" "}
								</button>
							</div>
						...
						<div className={style.pesquisa}>
							...
							<input
								...
								placeholder='Busque seu contato pelo nome'
								value={valor}
								onChange={() => {
